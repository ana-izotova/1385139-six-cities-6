...
Cборка: [Шесть городов](https://six-cities-ana-izotova.vercel.app)
...
*Благодаря этому проекту познакомилась с React (с использованием хуков и функциональных компонентов), Redux, Redux Toolkit, а также React DevTools. Самостоятельно разобралась с использованием TypeScript, что добавило сложности проекту. Училась оптимизировать приложение, а также протестировала его с помощью модульного и снэпшот-тестирования, а также функциональных тестов с использованием React Testing Library*
